            ...
            <div
                ...
                <div class="w-9 h-9 shrink-0 rounded-full bg-white/20 flex items-center justify-center text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        ...
                        stroke-linejoin="round" class="lucide lucide-user h-5 w-5" aria-hidden="true">
    ...
    <main class="px-1.5 md:px-3.5 py-4 space-y-7">
        <section
            ...
            <div class="text-center">
                <p class="font-display text-lg font-semibold">{{ _auth()->name }}</p>
        ...
        <section x-data="{ editProfile: false }" class="rounded-2xl border border-border bg-card backdrop-blur-xl">
            <header class="mb-3 flex items-center justify-between py-3.5 px-4 border-b border-border">
            ...
            <ul x-show="!editProfile" x-cloak x-transition class="divide-y divide-border">
                ...
                <li class="flex items-center gap-3 py-3 px-4">
                    <span class="grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-blue-50 dark:bg-blue-900/20">
                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512"
                            class="text-lg text-blue-600 dark:text-blue-400" height="1em" width="1em"
                ...
                <li class="flex items-center gap-3 py-3 px-4">
                    <span
                        class="grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-pink-50 dark:bg-pink-900/20 text-pink-500">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                @if (_auth()->phone)
                    <li class="flex items-center gap-3 py-3 px-4">
                        <span
                            class="grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-green-50 dark:bg-green-900/20">

                            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512"
                                class="text-lg text-green-600 dark:text-green-400" height="1em" width="1em"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
