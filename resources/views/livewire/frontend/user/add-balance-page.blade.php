<div class="main-content">
    ...
    <div
        class="relative overflow-hidden rounded-b-2xl md:rounded-b-3xl bg-linear-to-r from-violet-600 via-indigo-600 to-cyan-500 px-2 py-3.5 md:p-5 shadow-2xl">
        <!-- Blur Circles -->
    ...
    <main class="px-1.5 md:px-3.5 py-2 md:py-4 space-y-3 md:space-y-5">
        ...
        <!-- Step Line -->
        <div class="bg-card rounded-2xl border border-border px-2 md:px-4 py-2.5 md:py-3.5 space-y-4">
            <div class="flex items-baseline justify-between w-full">
                <p class="font-display text-sm md:text-base font-semibold text-foreground/90 capitalize">Step
                    {{ $step }}:
                    {{ $pageTitle }}</p>
            ...
            <div class="grid grid-cols-3">
                ...
                <div class="flex items-center">
                    ...
                    <span class="w-full h-1 {{ $step == 1 ? 'bg-pink-500' : 'bg-pink-400' }} inline"></span>
                ...
                <div class="flex items-center">
                    <span
                        class="w-full h-1 {{ ($step == 2 ? 'bg-pink-500 text-white' : $step == 3) ? 'bg-pink-400 text-white' : 'bg-gray-200/90 dark:bg-gray-100/20' }} inline"></span>
                    <span
                ...
                <div class="flex items-center">
                    <span
                        class="w-full h-1 {{ $step == 3 ? 'bg-pink-500 text-white' : 'bg-gray-200/90 dark:bg-gray-100/20' }} inline"></span>
                    <span
