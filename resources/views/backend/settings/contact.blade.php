...
@section('content')
    ...
    <div class="flex items-center justify-between">
        <!-- Left Title -->
        <h1 class="text-base md:text-lg font-semibold text-foreground">Contact Us</h1>
        <!-- Link -->
        <nav>
            <ol class="flex items-center gap-1.5">
                ...
                <li class="text-sm text-foreground">Contact Us</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="max-w-xl card">
        <div class="card-header">
            <h5 class="font-semibold text-foreground/90">Contact US</h5>
        </div>
